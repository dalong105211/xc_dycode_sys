...
from applications.view.admin.dycode import admin_dycode
from applications.view.admin.config import admin_config
...
def register_admin_views(app: Flask):
    ...
    app.register_blueprint(admin_dycode)
    app.register_blueprint(admin_config)
