layui.define(['jquery', 'element'], function(exports) {
	...
	pearTab.prototype.render = function(opt) {
		...
		$("body .layui-tab[lay-filter='" + option.elem + "'] .layui-tab-title").on("contextmenu", "li", function(e) {
			...
			var menu = "<ul><li class='item' id='" + option.elem + "closeThis'>Close</li><li class='item' id='" + option.elem +
				"closeOther'>Close others</li><li class='item' id='" + option.elem + "closeAll'>Close all</li></ul>";
	...
	function createTab(option) {
		...
		title += '</ul>';
		content += '</div>';
		control += '<dd id="closeThis"><a href="#">Close</a></dd>'
		control += '<dd id="closeOther"><a href="#">Close others</a></dd>'
