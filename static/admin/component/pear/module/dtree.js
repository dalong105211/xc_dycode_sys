...
//			level: "level",			  //层级
    ...
    DTree.prototype.setting = function(options) {
        ...
        this.none = this.options.none || OPTIONS.nont || "No data";	 //初始加载无记录时显示文字
    ...
    DTree.prototype.reloadSetting = function(options) {
        ...
        this.none = this.options.none || this.none;  //初始节点加载No data时显示文字
    ...
    DTree.prototype.selectSetting = function() {
        ...
        this.selectTips = this.options.selectTips || "Select";			// 输入框的提示语
    ...
    DTree.prototype.removeCheckedNode = function(){
        ...
        if(len == 0){
            ...
            layer.confirm('Confirm to remove this node?', {icon: 3, title:'Remove node'}, function(index1){
    ...
    DTree.prototype.toolbarListener = function(tool, $div) {
        ...
        switch (tool) {
            ...
            case defaultTool.delTool:
                layer.confirm('Confirm to remove the '+_this.toolbarStyle.title+'?', {icon: 3, title:'删除'+_this.toolbarStyle.title}, function(index){
    ...
    DTree.prototype.loadToolBar = function(title, name){
        ...
        switch (name) {
            case defaultTool.addTool:
                var addNodeBarDef = [{"label": "Current Selected", "name": "nodeTitle", "type": "text", "value": title, "defElem": "nowChoose", "readonly": true},
                    {"label": "Add "+_this.toolbarStyle.title, "name": "addNodeName", "type": "text", "value": "", "defElem": "nowChange", "verify": "required"},
                    {"type": "submit", "value": "Add Confirm", "defElem": "btn", "filter": "dtree_addNode_" + _this.obj[0].id + "_form"}];
            ...
            case defaultTool.editTool:
                var editNodeBarDef = [{"label": "Current selected", "name": "nodeTitle", "type": "text", "value": title, "defElem": "nowChoose", "readonly": true},
                    {"label": "Edit "+_this.toolbarStyle.title, "name": "editNodeName", "type": "text", "value": "", "defElem": "nowChange", "verify": "required"},
                    {"type": "submit", "value": "Edit Confirm", "defElem": "btn", "filter": "dtree_editNode_" + _this.obj[0].id + "_form"}];
