    ...
    u.prototype.type = function () {
        ...
        var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1,
            r = {
                ...
                count: '<span class="layui-laypage-count">' + ("function" == typeof a.parse.count ? a.parse.count(a.count, a) : "Total " + a.count + " count") + "</span>",
                limit: function () {
                ...
                switch (layui.stope(e), H.trigger("table.tool.panel.remove"), l.close(a.tipsIndex), r) {
                    ...
                    case "LAYTABLE_EXPORT":
                        d.ie ? l.tips("\u5bfc\u51fa\u529f\u80fd\u4e0d\u652f\u6301 IE\uff0c\u8bf7\u7528 Chrome \u7b49\u9ad8\u7ea7\u6d4f\u89c8\u5668\u5bfc\u51fa", this, {
                            ...
                            list: function () {
                                return ['<li data-type="csv">Export To Csv File</li>', '<li data-type="xls">Export To Excel File</li>'].join("")
                            }(),
                            done: function (e, l) {
                                l.on("click", function () {
                        ...
                        break;
                    case "LAYTABLE_PRINT":
                        var u = window.open("Print\u7a97\u53e3", "_blank"),
